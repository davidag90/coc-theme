                  ...
                  <aside id="certificacion" class="bg-light border shadow-sm rounded overflow-hidden p-4">
                     ...
                     <div id="certificantes" class="d-flex flex-row justify-content-around">
                        <?php if ($capacitacion_data['certificaciones'] === 'ucc') : ?>
                           <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/instituciones/coc.png" alt="COC">
                           <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/instituciones/ucc.png" alt="COC">
                        <?php else : ?>
                           <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/instituciones/coc.png" alt="COC">
                        <?php endif; ?>
                     </div>
