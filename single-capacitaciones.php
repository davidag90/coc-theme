         ...
         <div class="col-12 col-md-4">
            <aside id="detalles-inscripcion" class="bg-light border shadow-sm rounded overflow-hidden mb-4">
               ...
               <div class="botonera mb-4 px-4">
                  <a href="<?php print(!empty($producto_relacionado) ? home_url() . '/checkout/?add-to-cart=' . $producto_relacionado->post_id : 'https://wa.me/3512373661'); ?>" class="btn btn-warning w-100 py-2 link-light mb-2"><?php echo $tipo_inscripcion ?> &rarr;</a>
